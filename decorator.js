...
(function() {
    ...
    function bindEvent(context, shape) {
        ...
        addEvent(context.canvas, 'click', function() {
            ...
            // if (this.id === 'pencil-icon' || this.id === 'eraser-icon' || this.id === 'clearall-icon') {
            ...
            if (this.id === 'eraser-icon') {
                ...
                cache.compositeOperation = globalCompositeOperation;
                globalCompositeOperation = "destination-out";
                strokeStyle = 'White';
                fillStyle = 'White';
                lineWidth = 10;
            } else if (cache.strokeStyle && cache.fillStyle && cache.compositeOperation&& typeof cache.lineWidth !== 'undefined') {
                strokeStyle = cache.strokeStyle;
                fillStyle = cache.fillStyle;
                lineWidth = cache.lineWidth;
                globalCompositeOperation =  cache.compositeOperation;
            }

            //  if (this.id === 'clearall-icon') {
            //     cache.strokeStyle = strokeStyle;
            //     cache.fillStyle = fillStyle;
            //     cache.lineWidth = lineWidth;
            //     cache.compositeOperation = globalCompositeOperation;
    ...
    // -------------------------------------------------------------
    // function decorateClearAll() {
    //     var context = getContext('clearall-icon');
    ...
    //     context.fillStyle = 'Gray';
    //     context.font = '9px Verdana';
    //     context.fillText('ClearAll', 6, 12);

    //     bindEvent(context, 'ClearAll');
    // }

    // if (tools.clearall === true) {
    //     decorateClearAll();
    // } else document.getElementById('clearall-icon').style.display = 'none';
