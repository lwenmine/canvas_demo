...
var is = {
    ...
    set: function(shape) {
        ...
        // cache.isLine = cache.isArc = cache.isDragLastPath = cache.isDragAllPaths = cache.isRectangle = cache.isQuadraticCurve = cache.isBezierCurve = is.isPencil = is.isEraser = is.isText = is.isClearAll = false;
